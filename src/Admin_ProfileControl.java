...
public class Admin_ProfileControl extends Pane {

    private User user;
    private double width;
    private double height;
    private Button confirmButton;
    private Admin_ProfilePane pane;

    public Admin_ProfileControl(User user, double width, double height) {

        this.user = user;
        this.width = width;
        this.height = height;

        pane = new Admin_ProfilePane(user,width,height);
